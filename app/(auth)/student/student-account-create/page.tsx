...
export default function Page() {
  ...
  //
  const [studentDetails, setStudentDetails] = useState<studentPayloadProp>({
    role: "student",
    email: "",
    password: "",
    school: "",
  ...
  const submitStudentDetails = async (e: any) => {
    e.preventDefault();
    if (
    ...
    try {
      setIsLoading(true);
      const res = await api.post("/register", studentDetails);
      if (!res.data?.success) {
