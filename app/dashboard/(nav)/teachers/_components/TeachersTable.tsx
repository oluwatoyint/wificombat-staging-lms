        ...
        <table className="w-full border-collapse">
          <thead className="text-left bg-gray-100 text-gray-600">
            <tr>
              ...
              <th className="px-6 py-4 whitespace-nowrap">No. of Students</th>
              <th className="px-6 py-4 whitespace-nowrap">Class Report</th>
          ...
          <tbody className="divide-y">
            ...
            {data?.map((teacher: any) => (
              <tr key={teacher?.id} className="hover:bg-gray-50">
                <td className="px-6 py-4">{Truncate(teacher?.id, 7)}</td>
                <td className="px-6 py-4 flex items-center gap-3">
                  ...
                  <span className="whitespace-nowrap">
                    ...
                    {!teacher?.last_name && !teacher?.first_name && "N/A"}
                  </span>
                </td>
                <td className="px-6 py-4">{teacher?.email || "N/A"}</td>
                <td className="px-6 py-4">
                  {classArray?.find(
                    (_class) => _class?.value === teacher?._class
                  )?.name || "N/A"}
                </td>
                <td className="px-6 py-4">{teacher?.no_student_you_teach}</td>
                <td className="px-6 py-4">
