    ...
    <Fragment>
      ...
      >
        <DashboardHeader
          ...
          name={profileInfo?.first_name as string}
        />
        ...
        <main className="pb-10">
          <div className="px-4 sm:px-6 lg:px-8 lg:py-6 space-y-10">
            <div className="z-[1] relative w-full h-[12rem] lg:h-[14rem]">
              ...
              />
              <div className="absolute -bottom-[40px] left-10 h-[150px] w-[150px]">
                <Image
                  width={100}
                  height={100}
                  alt="profile"
                  src={`/profile-bg.jpeg`}
                  className="z-[1] relative w-full h-full object-cover rounded-full"
                />
                <label
                  htmlFor="profile_pic"
                  className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-[33] h-[110px] w-[110px] rounded-full"
                >
                  <div className="relative h-[110px] w-[110px] cursor-pointer">
                    ...
                    <EditIcon
                      size="30"
                      className="absolute z-[88] right-0 bottom-6"
                    />
                  </div>
                </label>
              </div>
                      ...
                      <div className="w-full mb-[1.5rem] relative">
                        ...
                        <div className="border flex items-center justify-between rounded-md focus:border-gray-600 py-4 px-4 shadow-sm ring-1 ring-inset ring-gray-300 sm:text-sm sm:leading-6">
                          <input
                            ...
                            value={
                              classArray?.find(
                                (item) => item?.value === profileDetails?._class
                              )?.name
                            }
                            onChange={() => {}}
                          />
