    ...
    <div>
      ...
      >
        {courses?.map((course: any) => (
          <div
            key={course?.id}
            className="flex w-full p-5 rounded-lg bg-primary-40 border border-primary-400 flex-wrap sm:flex-nowrap gap-4"
          >
            <Image
            ...
            <div className="w-full flex flex-col gap-3">
              <div className="flex justify-between items-center">
                <h3 className="font-bold text-xl capitalize sm:text-2xl">
                  {course?.title}
                </h3>
              ...
              <div className="bg-primary-50 h-[8px] w-full overflow-hidden rounded-full">
                <div
                  className="bg-primary-300 h-full rounded-full"
                  style={{ width: `${course?.user_course_progress}%` }}
                />
              </div>
            </div>
          </div>
